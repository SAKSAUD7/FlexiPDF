...
@layer components {
  ...
  .app-card:hover {
    @apply shadow-2xl -translate-y-2 border-white/30;
  ...
  /* PWA-specific styles */
  .pwa-install-banner {
    @apply fixed bottom-4 left-4 right-4 bg-white rounded-xl shadow-lg p-4 z-50 border border-gray-200;
  }
